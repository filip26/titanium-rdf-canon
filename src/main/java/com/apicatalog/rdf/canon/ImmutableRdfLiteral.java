...
class ImmutableRdfLiteral implements RdfLiteral {
    ...
    public String toString() {
        ...
        } else if (dataType != null && !NQuadsAlphabet.XSD_STRING.equals(dataType)) {
            builder.append("^^<");
    ...
    private static final String datatype(String langTag, String datatype) {
        ...
        return langTag == null ? NQuadsAlphabet.XSD_STRING : NQuadsAlphabet.LANG_STRING;
    }
}
